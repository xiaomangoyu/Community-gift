...
## Characterization
This is a synthetic reference-library archetype, not a real creator. The streamer type is fruit candy idol. Visual identity centers on cherry pair with leaf cap as the supporting cue. Palette direction: cherry red, candy pink, mint. Material direction: glossy resin, translucent jelly, soft enamel. Mood coverage: sweet, playful, designer_toy. The lightstick should explore double cherry lamp head with a soft leaf cap and bubble-bead rim. Variant focus: the broadest silhouette variation while keeping a product-like lightstick. Keep visible typography simple, Latin-only, and limited to the short fan-club label. Avoid Chinese characters, dense text, real faces, weapons, and literal streamer portraits.
